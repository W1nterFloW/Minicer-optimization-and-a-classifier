function [rhoP1, rhoM1] = J_UNIWARD(coverPath)
% ¼ÆËãJ-UNIWARDµÄÊ§Õæ
...
rhoP1(rhoP1 > wetPointConst) = wetPointConst;
rhoP1(isnan(rhoP1)) = wetPointConst;    
rhoP1(C_COEFFS > 1023) = wetPointConst;
    
rhoM1(rhoM1 > wetPointConst) = wetPointConst;
rhoM1(isnan(rhoM1)) = wetPointConst;
rhoM1(C_COEFFS < -1023) = wetPointConst;
